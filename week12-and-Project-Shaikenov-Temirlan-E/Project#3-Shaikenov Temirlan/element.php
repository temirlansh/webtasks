...
<menu>
<div class="name1">
	<h2>2017 Mustang GT Premium Fastback</h2>
	<h2 class="h21">$37,195</h2>
</div>
<br/>
<div class="cont">
	<div class="cont1">
		<p class="p3">City - Almaty</p>
		  <p class="p3"> Type - Coupe </p>
		   <p class="p3">Color - Yellow  </p>
	</div>
	<div class="cont2">
		<img src="mustang1.jpg" width="650px" height="450px">
	</div>
</div>
</menu>
